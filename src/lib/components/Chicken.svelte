...
>
  <g class="body">
    ...
    />
    <path
      d="M400 400C400 427.614 377.614 450 350 450L150 450C122.386 450 100 427.614 100 400L100 300C100 272.386 122.386 250 150 250L250 250L350 250C377.614 250 400 272.386 400 300L400 400Z"
      fill="currentColor"
    />
  </g>
  <g class="body neck">
  ...
  <g class="comb neck">
    ...
    />
    <path
      d="M425 50C425 63.8071 413.807 75 400 75L350 75C336.193 75 325 63.8071 325 50C325 36.1929 336.193 25 350 25L400 25C413.807 25 425 36.1929 425 50Z"
      fill="currentColor"
    />
  </g>
